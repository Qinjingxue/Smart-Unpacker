...
def _build_zip_sfx_bad_cd_and_payload_bad(root: Path) -> MatrixFixture:
    entries = {"bad.txt": b"bad payload in sfx", "good.txt": b"good payload in sfx"}
    data = bytearray(_zip_bytes(entries))
    data[_zip_payload_offset(data, "bad.txt") + 3] ^= 0x55
    eocd = _zip_eocd_offset(data)
    struct.pack_into("<HH", data, eocd + 8, 1, 99)
    struct.pack_into("<I", data, eocd + 16, 0)
    struct.pack_into("<H", data, eocd + 20, 0)
    prefix = b"MZ\x90\x00SFX-BAD-CD-PAYLOAD"
    return _fixture_from_bytes(
        root,
        "zip-sfx-bad-cd-payload.exe",
        prefix + bytes(data) + b"TAIL",
        zip_entries={"good.txt": b"good payload in sfx"},
    )
...
def _build_zip_carrier_then_eocd_then_entry_quarantine(root: Path) -> MatrixFixture:
    fixture = _build_zip_eocd_then_entry_quarantine(root)
    path = Path(fixture.source_input["path"])
    path.write_bytes(b"MZ-THREE-ROUND-ZIP" + path.read_bytes() + b"CARRIER-TAIL")
    return MatrixFixture(source_input={"kind": "file", "path": str(path)}, zip_entries=fixture.zip_entries)
...
def _build_7z_non_solid_with_trailing_junk(root: Path) -> MatrixFixture:
    fixture = _build_7z_non_solid_partial_salvage(root)
    path = Path(fixture.source_input["path"])
    original = path.read_bytes()
    path.write_bytes(original + b"TAIL")
    return MatrixFixture(
        source_input=fixture.source_input,
        expected_bytes=original,
        zip_entries=fixture.zip_entries,
    )
...
def _build_tar_gzip_checksum_and_truncated_member(root: Path) -> MatrixFixture:
    first = bytearray(_tar_member("complete.txt", b"complete gzip tar payload"))
    first[148:156] = b"000000\0 "
    second = _tar_member("truncated.bin", _pseudo_random_payload(8192))
    compressed = gzip.compress(bytes(first) + second[:512 + 257])
    return _fixture_from_bytes(
        root,
        "tar-gzip-checksum-and-truncated.tgz",
        compressed,
        tar_entries={"complete.txt": b"complete gzip tar payload"},
    )
...
def _build_tar_bzip2_checksum_and_truncated_member(root: Path) -> MatrixFixture:
    first = bytearray(_tar_member("complete.txt", b"complete bzip2 tar payload"))
    first[148:156] = b"000000\0 "
    second = _tar_member("truncated.bin", _pseudo_random_payload(8192))
    compressed = bz2.compress(bytes(first) + second[:512 + 257])
    return _fixture_from_bytes(
        root,
        "tar-bzip2-checksum-and-truncated.tbz2",
        compressed,
        tar_entries={"complete.txt": b"complete bzip2 tar payload"},
    )
...
def _build_tar_xz_checksum_and_truncated_member(root: Path) -> MatrixFixture:
    first = bytearray(_tar_member("complete.txt", b"complete xz tar payload"))
    first[148:156] = b"000000\0 "
    second = _tar_member("truncated.bin", _pseudo_random_payload(8192))
    compressed = lzma.compress(bytes(first) + second[:512 + 257], format=lzma.FORMAT_XZ)
    return _fixture_from_bytes(
        root,
        "tar-xz-checksum-and-truncated.txz",
        compressed,
        tar_entries={"complete.txt": b"complete xz tar payload"},
    )
...
SEVEN_ZIP_COMPETITION_MODULES = (
    ...
    "seven_zip_salvage_non_solid_entries",
)

RAR_COMPETITION_MODULES = (
...
MATRIX = [
    ...
    MatrixCase("zip_sfx_prefix_tail", "zip", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), _build_zip_sfx_prefix_tail, ("repaired", "partial"), "archive_carrier_crop_deep_recovery", _verify_zip),
    MatrixCase("zip_sfx_split_prefix_tail", "zip", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), _build_zip_sfx_split_prefix_tail, ("repaired", "partial"), "archive_carrier_crop_deep_recovery", _verify_zip),
    MatrixCase("zip_sfx_split_prefix_tail_bad_cd", "zip", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk", "central_directory_offset_bad", "central_directory_count_bad", "central_directory_bad"), _build_zip_sfx_split_prefix_tail_bad_cd, ("repaired", "partial"), "archive_carrier_crop_deep_recovery", _verify_zip),
    MatrixCase("zip_sfx_bad_cd_and_payload_bad", "zip", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk", "central_directory_offset_bad", "central_directory_count_bad", "central_directory_bad", "checksum_error", "crc_error", "damaged"), _build_zip_sfx_bad_cd_and_payload_bad, ("repaired", "partial"), "archive_carrier_crop_deep_recovery", _verify_zip),
    ...
    MatrixCase("7z_trailing_junk_v04", "7z", ("trailing_junk",), _build_7z_trailing_junk_v04, ("repaired",), "seven_zip_trim_trailing_junk", _verify_bytes),
    MatrixCase("7z_start_crc_bad_v03", "7z", ("start_header_crc_bad",), _build_7z_start_crc_bad_v03, ("repaired",), "seven_zip_fix_start_header_crc", _verify_bytes),
    MatrixCase("7z_next_crc_bad", "7z", ("next_header_crc_bad",), _build_7z_next_crc_bad, ("repaired",), "seven_zip_fix_next_header_crc", _verify_bytes),
    MatrixCase("7z_next_header_offset_bad", "7z", ("next_header_offset_bad", "start_header_corrupt"), _build_7z_next_header_offset_bad, ("repaired",), "seven_zip_fix_next_header_offset", _verify_bytes),
    MatrixCase("7z_next_header_size_bad", "7z", ("next_header_size_bad", "start_header_corrupt"), _build_7z_next_header_size_bad, ("repaired",), "seven_zip_fix_next_header_size", _verify_bytes),
    MatrixCase("7z_start_and_next_crc_bad", "7z", ("start_header_crc_bad", "next_header_crc_bad"), _build_7z_start_and_next_crc_bad, ("repaired",), "seven_zip_fix_next_header_crc", _verify_bytes),
    MatrixCase("7z_crc_fields_and_trailing_junk", "7z", ("start_header_crc_bad", "next_header_crc_bad", "trailing_junk"), _build_7z_crc_fields_and_trailing_junk, ("repaired",), "seven_zip_fix_next_header_crc", _verify_bytes),
    MatrixCase("7z_v03_start_next_crc_and_trailing_junk", "7z", ("start_header_crc_bad", "next_header_crc_bad", "trailing_junk"), _build_7z_v03_start_next_crc_and_trailing_junk, ("repaired",), "seven_zip_fix_next_header_crc", _verify_bytes),
    MatrixCase("7z_sfx_prefix_tail", "7z", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), _build_7z_sfx_prefix_tail, ("repaired",), "seven_zip_crop_carrier_prefix", _verify_bytes),
    MatrixCase("7z_sfx_fake_magic_then_real_payload", "7z", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), _build_7z_sfx_fake_magic_then_real_payload, ("repaired",), "seven_zip_crop_carrier_prefix", _verify_bytes),
    MatrixCase("7z_split_trailing_junk", "7z", ("trailing_junk", "boundary_unreliable"), _build_7z_split_trailing_junk, ("repaired",), "seven_zip_trim_trailing_junk", _verify_bytes),
    MatrixCase("7z_sfx_split_prefix_tail", "7z", ("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), _build_7z_sfx_split_prefix_tail, ("repaired",), "seven_zip_crop_carrier_prefix", _verify_bytes),
    ...
    MatrixCase("7z_solid_block_partial_salvage", "7z", ("solid_block_damaged", "packed_stream_bad", "damaged"), _build_7z_solid_block_salvage, ("partial",), "seven_zip_salvage_solid_prefix", _verify_zip, modules=("seven_zip_salvage_solid_prefix",)),
    MatrixCase("7z_non_solid_partial_salvage", "7z", ("non_solid", "packed_stream_bad", "damaged", "data_error"), _build_7z_non_solid_partial_salvage, ("partial",), "seven_zip_salvage_non_solid_entries", _verify_zip, modules=("seven_zip_salvage_non_solid_entries",)),
    MatrixCase("7z_competition_boundary_crc_salvage", "7z", ("non_solid", "trailing_junk", "boundary_unreliable", "packed_stream_bad", "damaged", "data_error"), _build_7z_non_solid_with_trailing_junk, ("repaired",), "seven_zip_trim_trailing_junk", _verify_bytes, modules=("seven_zip_trim_trailing_junk",), competition_modules=SEVEN_ZIP_COMPETITION_MODULES),
    MatrixCase("7z_competition_solid_vs_non_solid_salvage", "7z", ("non_solid", "packed_stream_bad", "damaged", "data_error"), _build_7z_non_solid_partial_salvage, ("partial",), "seven_zip_salvage_non_solid_entries", _verify_zip, modules=("seven_zip_salvage_non_solid_entries",), competition_modules=SEVEN_ZIP_COMPETITION_MODULES),
    MatrixCase("7z_non_solid_start_crc_bad_salvage", "7z", ("non_solid", "start_header_crc_bad", "packed_stream_bad", "damaged"), _build_7z_non_solid_with_start_crc_bad, UNREPAIRABLE, None, modules=("seven_zip_salvage_non_solid_entries",)),
    MatrixCase("7z_non_solid_generic_folder_bad", "7z", ("folder_bad", "packed_stream_bad", "damaged", "data_error"), _build_7z_non_solid_partial_salvage, ("partial",), "seven_zip_salvage_non_solid_entries", _verify_zip, modules=("seven_zip_salvage_non_solid_entries",)),
    ...
    MatrixCase("rar_competition_carrier_block_quarantine", "rar", ("rar4", "carrier_archive", "sfx", "trailing_junk", "boundary_unreliable", "file_block_bad", "damaged", "data_error"), _build_rar4_carrier_then_file_quarantine, ("partial",), "rar4_file_quarantine_rebuild", _verify_bytes, modules=("rar4_file_quarantine_rebuild",), competition_modules=RAR_COMPETITION_MODULES),
    ...
    MatrixCase("tar_gzip_checksum_and_truncated_member", "tar.gz", ("tar_checksum_bad", "input_truncated", "probably_truncated", "unexpected_end", "damaged"), _build_tar_gzip_checksum_and_truncated_member, ("partial", "repaired"), "tar_gzip_truncated_partial_recovery", _verify_tar, modules=("tar_gzip_truncated_partial_recovery",)),
    MatrixCase("tar_gzip_competition_stream_vs_tar_partial", "tar.gz", ("input_truncated", "probably_truncated", "unexpected_end", "damaged", "data_error"), _build_tar_gzip_truncated_keeps_complete_member, ("partial", "repaired"), "tar_gzip_truncated_partial_recovery", _verify_tar, modules=("tar_gzip_truncated_partial_recovery",), competition_modules=TAR_GZIP_COMPETITION_MODULES),
    ...
    MatrixCase("tar_bzip2_checksum_and_truncated_member", "tar.bz2", ("tar_checksum_bad", "input_truncated", "probably_truncated", "unexpected_end", "damaged"), _build_tar_bzip2_checksum_and_truncated_member, ("partial", "repaired"), "tar_bzip2_truncated_partial_recovery", _verify_tar, modules=("tar_bzip2_truncated_partial_recovery",)),
    MatrixCase("tar_bzip2_competition_stream_vs_tar_partial", "tar.bz2", ("input_truncated", "probably_truncated", "unexpected_end", "damaged", "data_error"), _build_tar_bzip2_truncated_keeps_complete_member, ("partial", "repaired"), "tar_bzip2_truncated_partial_recovery", _verify_tar, modules=("tar_bzip2_truncated_partial_recovery",), competition_modules=TAR_BZIP2_COMPETITION_MODULES),
    ...
    MatrixCase("tar_xz_checksum_and_truncated_member", "tar.xz", ("tar_checksum_bad", "input_truncated", "probably_truncated", "unexpected_end", "damaged"), _build_tar_xz_checksum_and_truncated_member, ("partial", "repaired"), "tar_xz_truncated_partial_recovery", _verify_tar, modules=("tar_xz_truncated_partial_recovery",)),
    MatrixCase("tar_xz_competition_stream_vs_tar_partial", "tar.xz", ("input_truncated", "probably_truncated", "unexpected_end", "damaged", "data_error"), _build_tar_xz_truncated_keeps_complete_member, ("partial", "repaired"), "tar_xz_truncated_partial_recovery", _verify_tar, modules=("tar_xz_truncated_partial_recovery",), competition_modules=TAR_XZ_COMPETITION_MODULES),
...
MULTI_ROUND_MATRIX = [
    ...
    MultiRoundCase(
        "zip_carrier_then_cd_payload_salvage",
        "zip",
        _build_zip_carrier_then_eocd_then_entry_quarantine,
        (
            RepairRound(("carrier_archive", "sfx", "boundary_unreliable", "trailing_junk"), ("repaired", "partial"), "archive_carrier_crop_deep_recovery", modules=("archive_carrier_crop_deep_recovery",)),
    ...
    MultiRoundCase(
        ...
        (
            RepairRound(("start_header_crc_bad",), ("repaired",), "seven_zip_fix_start_header_crc", modules=("seven_zip_fix_start_header_crc",)),
            RepairRound(("solid_block_damaged", "packed_stream_bad", "damaged"), ("partial",), "seven_zip_salvage_solid_prefix", modules=("seven_zip_salvage_solid_prefix",)),
        ),
        _verify_zip,
    ),
    MultiRoundCase(
        ...
        (
            RepairRound(("start_header_crc_bad",), ("repaired",), "seven_zip_fix_start_header_crc", modules=("seven_zip_fix_start_header_crc",)),
            RepairRound(("non_solid", "packed_stream_bad", "damaged"), ("partial",), "seven_zip_salvage_non_solid_entries", modules=("seven_zip_salvage_non_solid_entries",)),
        ),
        _verify_zip,
    ),
    MultiRoundCase(
