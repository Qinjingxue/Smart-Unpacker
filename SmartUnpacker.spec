...
for package in (
    ...
    "smart_unpacker.analysis.structure_pipeline.modules",
    "smart_unpacker.analysis.fuzzy_pipeline.modules",
    "smart_unpacker.repair.pipeline.modules",
    "smart_unpacker.repair.pipeline.modules.rar",
    "smart_unpacker.repair.pipeline.modules.seven_zip",
    "smart_unpacker.repair.pipeline.modules.zip",
    "smart_unpacker.repair.pipeline.modules.tar",
    "smart_unpacker.passwords.candidates",
    "smart_unpacker.extraction.internal",
    "smart_unpacker.rename.internal",
    "smart_unpacker.relations.internal",
    "smart_unpacker.postprocess.internal",
