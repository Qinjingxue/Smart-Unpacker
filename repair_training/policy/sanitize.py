...
def sanitize_training_graph(graph: dict[str, Any]) -> dict[str, Any]:
...
def _sanitize_node(node_id: Any, node: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "recovery": sanitize_recovery(node.get("recovery") if isinstance(node.get("recovery"), dict) else {}),
        ...
        "diagnosis_hgt": sanitize_diagnosis_hgt(node.get("diagnosis_hgt") if isinstance(node.get("diagnosis_hgt"), dict) else {}),
...
def sanitize_memory_entry(entry: dict[str, Any]) -> dict[str, Any]:
    output = {
        ...
        "current_recovery": sanitize_recovery(entry.get("current_recovery") if isinstance(entry.get("current_recovery"), dict) else {}),
        "best_seen_recovery": sanitize_recovery(entry.get("best_seen_recovery") if isinstance(entry.get("best_seen_recovery"), dict) else {}),
        "diagnosis_hgt": sanitize_diagnosis_hgt(entry.get("diagnosis_hgt") if isinstance(entry.get("diagnosis_hgt"), dict) else {}),
...
def sanitize_action_features(payload: dict[str, Any]) -> dict[str, Any]:
    allowed = (
        "action_type",
        "action_id",
        "candidate_id",
...
def sanitize_recovery(payload: dict[str, Any]) -> dict[str, Any]:
    keys = (
        "score",
        "completeness",
        "status",
...
def _sanitize_predicted_next_state(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "predicted_recovery": sanitize_recovery(recovery),
...
def sanitize_diagnosis_hgt(payload: dict[str, Any]) -> dict[str, Any]:
