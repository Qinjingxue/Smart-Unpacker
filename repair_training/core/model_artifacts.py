...
def write_model_artifacts(
    ...
    *,
    ...
    _write_json(model_dir / ("action_schema.json" if model_type == "step_action" else "label_schema.json"), label_schema)
    ...
    model_card = {
        ...
        "algorithm": "lightgbm",
        "policy_semantics": "step_q_v1" if model_type in {"step_action", "step_value"} else "",
