    ...
    return RepairScheduler({
        "repair": {
            ...
            "modules": [
                ...
                {"name": "zip_eocd_repair", "enabled": False},
                {"name": "zip_comment_length_fix", "enabled": False},
                {"name": "zip_central_directory_count_fix", "enabled": False},
                {"name": "zip_central_directory_offset_fix", "enabled": False},
                {"name": "zip64_field_repair", "enabled": False},
                {"name": "zip_local_header_field_repair", "enabled": False},
                {"name": "zip_trailing_junk_trim", "enabled": False},
                {"name": "zip_central_directory_rebuild", "enabled": False},
                {"name": "zip_data_descriptor_recovery", "enabled": False},
                {"name": "zip_local_header_verified_salvage", "enabled": False},
                {"name": "zip_cd_local_header_reconcile_rebuild", "enabled": False},
                {"name": "zip_entry_quarantine_rebuild", "enabled": False},
                {"name": "zip_partial_recovery", "enabled": False},
                {"name": "zip_deep_partial_recovery", "enabled": False},
                {"name": "zip_missing_volume_partial_salvage", "enabled": False},
                {"name": "zip_conflict_resolver_rebuild", "enabled": False},
            ],
        }
    })
