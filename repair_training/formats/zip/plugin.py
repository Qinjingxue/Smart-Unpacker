...
def damage_feature_spec() -> TrainingFeatureSpec:
    return TrainingFeatureSpec(
        include_prefixes=(
            ...
            "runtime_context.analysis_native_probe.structure.",
            "runtime_context.analysis_native_probe.raw_structure.",
        ...
        categorical_paths=(
            ...
            "runtime_context.verification_summary.assessment_status",
            "runtime_context.verification_summary.source_integrity",
            "runtime_context.analysis_native_probe.structure.eocd.error",
            "runtime_context.analysis_native_probe.structure.local_header.error",
            "runtime_context.analysis_native_probe.raw_structure.eocd.error",
            "runtime_context.analysis_native_probe.raw_structure.local_header.error",
        ),
        ignore_prefixes=(
        ...
        ignore_paths=(
            ...
            "runtime_context.analysis_native_probe.structure.eocd.entry_count_delta",
            "runtime_context.analysis_native_probe.raw_structure.eocd.entry_count_delta",
        ),
    )
