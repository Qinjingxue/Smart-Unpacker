...
def damage_feature_spec() -> TrainingFeatureSpec:
    return TrainingFeatureSpec(
        include_prefixes=(
            ...
            "runtime_context.analysis_native_probe.raw_structure.graph.summary.",
            "runtime_context.analysis_native_probe.raw_structure.graph.violations.",
            "runtime_context.analysis_native_probe.raw_structure.graph.explanations.",
            "runtime_context.analysis_native_probe.raw_structure.summary.",
            "runtime_context.analysis_native_probe.raw_structure.runtime.",
            "runtime_context.analysis_native_probe.raw_structure.anomaly.summary.",
            "runtime_context.analysis_native_probe.raw_structure.anomaly.objects.",
        ...
        categorical_paths=(
            ...
            "runtime_context.analysis_native_probe.raw_structure.graph.error",
        ),
        ignore_prefixes=(
            ...
            "runtime_context.analysis_native_probe.raw_structure.graph.nodes",
            "runtime_context.analysis_native_probe.raw_structure.graph.edges",
        ),
        ignore_paths=(
