...
from packrelic.support.path_keys import case_key, normalized_path
...
class SplitVolumeNormalizer:
    ...
    def normalize(
        ...
        temp_dir = tempfile.mkdtemp(prefix=".packrelic-volumes-", dir=os.path.dirname(archive) or None)
        try:
