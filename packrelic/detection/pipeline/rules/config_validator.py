...
from packrelic.detection.pipeline.facts.schema import known_fact_names, matches_schema_type
...
class RuleConfigValidator:
    ...
    def validate_rule_facts(self, layer: str, rule_name: str, rule_cls: Any):
        ...
        if unknown and module_name.startswith("packrelic.detection.pipeline.rules."):
