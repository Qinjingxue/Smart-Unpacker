...
from packrelic_native import scan_after_markers as _NATIVE_SCAN_AFTER_MARKERS
from packrelic_native import scan_carrier_archive as _NATIVE_SCAN_CARRIER_ARCHIVE
from packrelic_native import scan_magics_anywhere as _NATIVE_SCAN_MAGICS_ANYWHERE
...
from packrelic.detection.pipeline.processors.modules.format_structure.zip_local_header import inspect_zip_local_header
from packrelic.detection.pipeline.processors.registry import register_processor
from packrelic.support.config_values import bool_value, non_negative_int, optional_positive_int, positive_int
