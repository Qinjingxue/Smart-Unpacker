...
from packrelic.repair.config import repair_config
...
from packrelic.verification.result import VerificationResult
...
class ArchiveRepairStage:
    ...
    def _workspace_root(self) -> Path:
        return Path(str(self.config.get("workspace") or ".packrelic_repair"))
