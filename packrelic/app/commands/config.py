...
from packrelic.app.cli_parsers import CliHelpFormatter, build_config_output_parser, localize_help_action
...
from packrelic.config.payload_io import read_config_payload
...
TEXTS = {
    "en": {
        "help": "Show or validate packrelic_config.json.",
    ...
    "zh": {
        "help": "查看或校验 packrelic_config.json。",
        "show_help": "打印当前配置文件。",
...
def register(subparsers, ctx):
    ...
    config_parser = subparsers.add_parser(
        ...
        usage="pkrc config [options] <show|validate>",
