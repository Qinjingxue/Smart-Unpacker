...
from packrelic.app.cli_commands import command_map, discover_command_modules
from packrelic.app.cli_constants import EXIT_OK, EXIT_RUNTIME, EXIT_USAGE
from packrelic.app.cli_context import (
    CliContext,
)
from packrelic.config.cli_settings import DEFAULT_CLI_LANG, load_cli_language_from_config, normalize_cli_language
...
def build_cli_parser(ctx: CliContext | None = None) -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  pkrc extract C:\\Archives\n"
            "  pkrc inspect .\\fixtures\n"
            "  pkrc passwords --ask-pw"
        ),
