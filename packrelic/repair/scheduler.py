...
from packrelic.repair.candidate import CandidateSelector, CandidateValidation, RepairCandidate, RepairCandidateBatch
from packrelic.repair.capability import ModuleCapabilityDecision, RepairCapabilityDecision
from packrelic.repair.config import enabled_module_configs, repair_config
from packrelic.repair.context import RepairContext, build_repair_context
from packrelic.repair.diagnosis import RepairDiagnosis, diagnose_repair_job
from packrelic.repair.job import RepairJob
from packrelic.repair.pipeline.module import RepairRoute
from packrelic.repair.pipeline.modules._common import job_source_size
...
class RepairScheduler:
    ...
    def _workspace_for(self, job: RepairJob) -> Path:
        base = Path(job.workspace or self.config.get("workspace") or ".packrelic_repair")
