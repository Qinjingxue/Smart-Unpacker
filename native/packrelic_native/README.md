...
Rust/PyO3 extension module for narrow native helpers used by PackRelic.
...
python -m maturin build --manifest-path native\packrelic_native\Cargo.toml --release
```

Install the generated wheel:

```powershell
$wheel = Get-ChildItem native\packrelic_native\target\wheels\packrelic_native-*.whl | Select-Object -First 1 -ExpandProperty FullName
...
```powershell
python -c "import packrelic_native; print(packrelic_native.native_available(), packrelic_native.scanner_version())"
```
