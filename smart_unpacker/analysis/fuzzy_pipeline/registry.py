...
from smart_unpacker.analysis.fuzzy_pipeline.module import FuzzyAnalysisModule
...
def discover_fuzzy_analysis_modules():
    ...
    package = importlib.import_module("smart_unpacker.analysis.fuzzy_pipeline.modules")
