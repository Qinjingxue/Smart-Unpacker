...
from sunpack.repair.evidence import RepairAnalysisEvidence, RepairAnalysisSegment
...
class ArchiveRepairStage:
    """Own repair-job construction and repair scheduler application."""
    ...
    def _inspection_evidences_from_facts(self, task: ArchiveTask) -> list[RepairAnalysisEvidence]:
        ...
        for item in knowledge_view.inspection_evidences(task):
            ...
            evidences.append(RepairAnalysisEvidence(
    ...
    def _damage_flags_from_evidence(self, evidence: RepairAnalysisEvidence) -> list[str]:
        flags = []
