...
CORE_TEXTS = {
    "en": {
        ...
        "clipboard_passwords": "Read text passwords from the clipboard once at startup.",
        ...
        "no_directory_passwords": "Disable same-directory password list discovery during extraction.",
        "directory_password_file": "Same-directory password list filename to prefer. Can be passed multiple times.",
    ...
    "zh": {
        ...
        "clipboard_passwords": "启动时读取剪贴板文本作为密码来源。",
        ...
        "no_directory_passwords": "禁用解压时同目录密码表发现。",
        "directory_password_file": "同目录密码表文件名，可重复传入多次。",
