...
from sunpack.detection.pipeline.processors.modules.format_structure.multi_volume import detection_binary_view, inspect_zip_local_header_view
...
def process_zip_local_header(context: FactProcessorContext) -> dict[str, Any]:
    return inspect_zip_local_header_view(detection_binary_view(context), 0)
