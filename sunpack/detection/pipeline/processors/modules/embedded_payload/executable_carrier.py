...
from sunpack_native import executable_runtime_bundle_profile
...
def classify_executable_carrier(
    ...
    *,
    ...
    runtime_profile = executable_runtime_bundle_profile(
        path,
        max(0, scan_limit_bytes),
        max(0, int(overlay.get("overlay_offset") or 0)),
    )
    if runtime_profile:
...
def _result(
    ...
    *,
    ...
    return {
        ...
        "payload_detected_ext": str(overlay.get("detected_ext") or ""),
    }
